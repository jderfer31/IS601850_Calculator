...
class MyTestCase(unittest.TestCase):
    ...
    def test_add_method_calculator(self):
        ...
        for row in self.test_data:
            self.assertAlmostEqual(self.calculator.add(row['Value 1'], row['Value 2']), (row['Result']))
    ...
    def test_subtract_method_calculator(self):
        ...
        for row in self.test_data:
            self.assertAlmostEqual(self.calculator.subtract(row['Value 1'], row['Value 2']), (['Result']))
            self.assertEqual(self.calculator.result, row['Result'])
            print(self.calculator.result)
    ...
    def test_multiply_method_calculator(self):
        ...
        for row in self.test_data:
            self.assertAlmostEqual(self.calculator.multiply(row['Value 1'], row['Value 2']), (['Result']))
            self.assertEqual(self.calculator.result, row['Result'])
            print(self.calculator.result)
